...
import { getTwitterFeed, TwitterTweet } from '@wc/lib/api';
...
export const TwitterSidebar = ({ twitterHandle = 'OfficialFIFA' }: TwitterSidebarProps) => {
  ...
  const tweetIntentUrl = `https://x.com/intent/tweet?hashtags=FIFA2026,WorldCup`;
    ...
    <section className="w-full max-w-4xl mx-auto py-8 relative z-10">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground ml-2">Latest from the FIFA 2026 World Cup</span>
        </div>
        {isOpen ? (
