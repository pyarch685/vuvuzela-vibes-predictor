...
import { getBenchmarkResults, triggerScrapeRefresh, BenchmarkSummary, BenchmarkMatch, isAuthenticated } from '@wc/lib/api';
...
const Benchmark = () => {
  ...
  const handleRefresh = async () => {
    setRefreshing(true);
    try {
      toast({ title: 'Refreshing...', description: 'Scraping FIFA.com for latest World Cup 2026 results.' });
            ...
            <main className="w-full max-w-5xl flex flex-col space-y-8">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground text-lg">
                  Predictions vs Real FIFA World Cup 2026 Results from{' '}
                  <a href="https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026" target="_blank" rel="noopener noreferrer" className="text-secondary underline hover:text-secondary/80">
                    fifa.com
                  </a>
                </p>
                  ...
                  <StadiumCard title="Match-by-Match Results">
                    {matches.length === 0 ? (
                      <p className="text-center text-muted-foreground py-8">
                        No benchmark matches available yet. Results will appear once matches are played and scraped from fifa.com.
                      </p>
                    ) : (
